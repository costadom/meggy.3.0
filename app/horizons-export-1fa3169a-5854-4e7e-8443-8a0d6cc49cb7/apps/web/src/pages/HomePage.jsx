...
import BecomeModelSection from '@/components/BecomeModelSection.jsx';
...
const HomePage = () => {
  const fictionalModels = [
    {
      id: 1,
      name: 'Juju Bates',
      description: 'Gameplay e conversa com vídeo. Estilo namoradinha, ideal para quem quer jogar, conversar e ter uma companhia mais próxima durante a sessão.',
      price: 50,
      credits: 50,
    ...
    },
    {
      id: 2,
      name: 'Luna',
      description: 'Gameplay + conversa. Luna oferece sessões leves, divertidas e personalizadas para quem quer joga junto, assistir junto, joga e reage.',
      price: 79,
      credits: 79,
    ...
    },
    {
      id: 3,
      name: 'Maya',
      description: 'Joga junto. Maya tem um perfil mais intense e competitivo, ideal para uma sessão com energia, interação e partidas agitadas.',
      price: 99,
      credits: 99,
    ...
    },
    {
      ...
      description: 'Gameplay puro. Parceiro ideal para sessões de gameplay intenso, com foco em competição e diversão.',
      price: 60,
      credits: 60,
      badges: ['Online agora'],
    ...
    },
    {
      id: 5,
      name: 'Rafael Costa',
      description: 'Conversa e companhia. Ideal para quem quer bom papo, companhia descontraída e diversão durante a sessão.',
      price: 45,
      credits: 45,
      badges: ['Nova'],
    ...
    },
    {
      id: 6,
      name: 'Sophia Martins',
      description: 'Conversa + gameplay. Sophia combina bom papo, diversão e sessões personalizadas para quem quer companhia e entretenimento.',
      price: 55,
      credits: 55,
  ...
  return (
    <div className="min-h-screen flex flex-col dark">
      <Helmet>
        <title>Meggy | Escolha sua gamer e agende sua sessão exclusiva</title>
        <meta name="description" content="A plataforma premium para conectar você às melhores gamers para sessões exclusivas por vídeo." />
      </Helmet>
