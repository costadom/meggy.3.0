...
migrate((app) => {
  ...
  collection.listRule = "status_aprovacao = 'Publicada' || @request.auth.collectionName = 'admin_users'";
  collection.viewRule = "status_aprovacao = 'Publicada' || @request.auth.collectionName = 'admin_users'";
